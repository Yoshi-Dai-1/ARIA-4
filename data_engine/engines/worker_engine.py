            ...
            if not zip_ok:
                ...
                if catalog_zip:
                    try:
                        ...
                        if is_404(e):
                            logger.error(f"HF ZIP missing for {doc_id} (404). Recovery impossible.")
                            anomaly_status = "failure"
                        else:
            ...
            if not pdf_ok:
                ...
                if catalog_pdf:
                    try:
                        ...
                        if is_404(e):
                            logger.error(f"HF PDF missing for {doc_id} (404).")
                            raw_pdf.unlink(missing_ok=True)
                        else:
                ...
                if not eng_ok:
                    ...
                    if catalog_eng:
                        try:
                            ...
                            if is_404(e):
                                logger.error(f"HF English docs missing for {doc_id} (404).")
                            else:
                ...
                if not att_ok:
                    ...
                    if catalog_att:
                        try:
                            ...
                            if is_404(e):
                                logger.error(f"HF Attachment docs missing for {doc_id} (404).")
                            else:
