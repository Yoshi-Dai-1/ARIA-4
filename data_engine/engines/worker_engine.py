...
class WorkerEngine:
    ...
    def run(self):
        ...
        for row in all_meta:
            ...
            if row.get("englishDocFlag") == "1" and not api_purged:
            ...
            if attach_flag and not api_purged:
                ...
                try:
                    ...
                    api_purged = True
            elif attach_flag and api_purged:
                logger.debug(f"Skip Attachment DL for {doc_id} (already known as purged)")
